...
const dictionaries: Record<Locale, Dictionary> = {
  vi: {
    ...
    "billing.tokenAmount": "Token usage",
    ...
    "knowledge.backToBases": "Quay lại Knowledge Base",
    "knowledge.documents": "Tài liệu",
    "knowledge.chunks": "Chunks",
    "knowledge.size": "Dung lượng",
    "knowledge.docsCount": "{count} tài liệu",
    "knowledge.chunksCount": "{count} chunks",
    "knowledge.loadDetailsFailed": "Không thể tải chi tiết knowledge base",
    "knowledge.deleteDocConfirm": "Bạn có chắc muốn xóa tài liệu này không?",
    "knowledge.deleteDocSuccess": "Đã xóa tài liệu thành công",
    "knowledge.deleteDocFailed": "Không thể xóa tài liệu",
    "knowledge.popupBlocked": "Trình duyệt đã chặn popup. Vui lòng cho phép popup để xem tài liệu.",
    "knowledge.accessDocFailed": "Không thể truy cập tài liệu. Vui lòng thử lại.",
    "knowledge.permissionDenied": "Bạn không có quyền xem knowledge base này.",
    "knowledge.notFound": "Không tìm thấy Knowledge Base",
    "knowledge.uploadDocument": "Tải tài liệu lên",
    "knowledge.uploadDocuments": "Tải tài liệu lên",
    "knowledge.noDocsYet": "Chưa có tài liệu nào",
    "knowledge.noDocsYetDesc": "Tải tài liệu lên để bắt đầu",
    "knowledge.tableName": "Tên",
    "knowledge.tableSize": "Dung lượng",
    "knowledge.tableChunks": "Chunks",
    "knowledge.tableStatus": "Trạng thái",
    "knowledge.tableUploaded": "Đã tải lên",
    "knowledge.statusIndexed": "Đã chỉ mục",
    "knowledge.statusProcessing": "Đang xử lý ({progress}%)",
    "knowledge.statusFailed": "Thất bại",
    "knowledge.statusPending": "Đang chờ",
    "knowledge.statusUploading": "Đang tải lên...",
    "knowledge.statusUploadFailed": "Tải lên thất bại",
    "knowledge.uploadedBy": "bởi {email}",
    "knowledge.createTitle": "Tạo Knowledge Base",
    "knowledge.iconLabel": "Icon",
    "knowledge.nameLabel": "Tên",
    "knowledge.namePlaceholder": "Ví dụ: Tài liệu sản phẩm",
    "knowledge.descriptionLabel": "Mô tả",
    "knowledge.descriptionPlaceholder": "Mô tả ngắn gọn về knowledge base này...",
    "knowledge.uploadTitle": "Tải tài liệu lên",
    "knowledge.dragActivePrompt": "Thả các tệp vào đây",
    "knowledge.dragNormalPrompt": "Kéo & thả các tệp vào đây hoặc click để duyệt",
    "knowledge.uploadHint": "PDF, DOCX, TXT, MD, PNG, JPG (tối đa 20MB)",
    "knowledge.visionHint": "Hình ảnh được tự động xử lý bằng Gemini Vision AI",
    "knowledge.filesHeader": "Tệp ({count})",
    "knowledge.uploadedAndIndexed": "Đã tải lên & chỉ mục",
    "knowledge.closeBackground": "Đóng (Chạy ẩn)",
    "knowledge.uploadFiles": "Tải tệp lên",
    "knowledge.assignFailed": "Không thể tải cài đặt tri thức",
    "knowledge.assignPermissionDenied": "Bạn không có quyền quản lý cấu hình tri thức cho chatbot.",
    "knowledge.assignTitle": "Knowledge Bases",
    "knowledge.assignDescription": "Chọn các knowledge base mà chatbot này được phép truy cập",
    "knowledge.assignSaveSuccess": "Đã lưu cài đặt tri thức",
    "knowledge.assignSaveFailed": "Không thể lưu cài đặt",
    "knowledge.docsChunksSummary": "{docs} tài liệu • {chunks} chunks",
  ...
  en: {
    ...
    "knowledge.backToBases": "Back to Knowledge",
    "knowledge.documents": "Documents",
    "knowledge.chunks": "Chunks",
    "knowledge.size": "Size",
    "knowledge.docsCount": "{count} docs",
    "knowledge.chunksCount": "{count} chunks",
    "knowledge.loadDetailsFailed": "Failed to load knowledge base details",
    "knowledge.deleteDocConfirm": "Delete this document?",
    "knowledge.deleteDocSuccess": "Document deleted",
    "knowledge.deleteDocFailed": "Failed to delete document",
    "knowledge.popupBlocked": "Popup was blocked. Please allow popups to preview documents.",
    "knowledge.accessDocFailed": "Failed to access document. Please try again.",
    "knowledge.permissionDenied": "You do not have permission to view this knowledge base.",
    "knowledge.notFound": "Knowledge Base not found",
    "knowledge.uploadDocument": "Upload Document",
    "knowledge.uploadDocuments": "Upload Documents",
    "knowledge.noDocsYet": "No documents yet",
    "knowledge.noDocsYetDesc": "Upload documents to get started",
    "knowledge.tableName": "Name",
    "knowledge.tableSize": "Size",
    "knowledge.tableChunks": "Chunks",
    "knowledge.tableStatus": "Status",
    "knowledge.tableUploaded": "Uploaded",
    "knowledge.statusIndexed": "Indexed",
    "knowledge.statusProcessing": "Processing ({progress}%)",
    "knowledge.statusFailed": "Failed",
    "knowledge.statusPending": "Pending",
    "knowledge.statusUploading": "Uploading...",
    "knowledge.statusUploadFailed": "Upload Failed",
    "knowledge.uploadedBy": "by {email}",
    ...
    "knowledge.descriptionPlaceholder": "Briefly describe this knowledge base...",
    "knowledge.uploadTitle": "Upload Documents",
    "knowledge.dragActivePrompt": "Drop files here",
    "knowledge.dragNormalPrompt": "Drag & drop files here or click to browse",
    "knowledge.uploadHint": "PDF, DOCX, TXT, MD, PNG, JPG (max 20MB)",
    "knowledge.visionHint": "Images are automatically processed using Gemini Vision AI",
    "knowledge.filesHeader": "Files ({count})",
    "knowledge.uploadedAndIndexed": "Uploaded & Indexed",
    "knowledge.closeBackground": "Close (Background)",
    "knowledge.uploadFiles": "Upload Files",
    "knowledge.assignFailed": "Failed to load knowledge settings",
    "knowledge.assignPermissionDenied": "You do not have permission to manage chatbot knowledge assignments.",
    "knowledge.assignTitle": "Knowledge Bases",
    "knowledge.assignDescription": "Select which knowledge bases this chatbot can access",
    "knowledge.assignSaveSuccess": "Knowledge settings saved",
    "knowledge.assignSaveFailed": "Failed to save settings",
    "knowledge.docsChunksSummary": "{docs} docs • {chunks} chunks",
